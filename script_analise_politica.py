...
PALAVRAS_CHAVE_ESQUERDA = {
    ...
    "estado", "estatal", "público", "pública", "serviço público", "serviços públicos",
    "direitos", "direito", "justiça social", "justiça", "igualdade", "equidade",
    "redistribuição", "distribuição de renda", "reforma agrária", "reforma urbana",
    "democracia", "democrático", "democrática", "participação popular",
    "sus", "saúde pública", "educação pública", "universidade pública",
    "ciência pública", "pesquisa pública", "cultura pública",
    
    # Movimentos sociais
    "movimento popular", "movimentos populares", "movimento social", "movimentos sociais",
    "luta", "lutas", "greve", "greves", "sindicato", "sindicatos", "centrais sindicais",
    "mst", "mtst", "mnlm", "movimento negro", "movimento feminista", "movimento lgbtqia+",
    "feminismo", "antirracismo", "antiracismo", "antifascismo", "anti-fascismo",
    
    # Termos identitários
    "classe trabalhadora", "trabalhadores", "trabalhadoras", "proletariado",
    "oprimidos", "oprimidas", "minorias", "diversidade", "inclusão", "pluralidade",
    "lgbt", "lgbtqia+", "lgbtqi+", "trans", "travesti", "homofobia", "transfobia",
    "racismo", "racista", "machismo", "machista", "patriarcado",
    
    # Temas ambientais
    "meio ambiente", "ambiental", "ambientalista", "sustentabilidade",
    "amazônia", "amazônica", "floresta", "florestas", "desmatamento",
    "indígena", "indígenas", "quilombola", "quilombolas", "povos tradicionais",
    
    # Críticas ao oponente
    "fascismo", "fascista", "fascistas", "autoritarismo", "autoritário",
    "neoliberalismo", "neoliberal", "privatista", "privatistas",
    "elite", "elites", "burguesia", "latifundiário", "latifundiários",
    
    # Hashtags ESQUERDA (peso extra)
    "#forabolsonaro", "#foragenocida", "#bolsonarogenocida", "#bolsonaronuncaMais",
    "#lula", "#lula2026", "#lula13", "#pt", "#pt13", "#ptbrasil",
    "#elenão", "#elejamais", "#notemernuncamais", "#foratemer",
    "#mariellepresente", "#mariellevive", "#justiçapormarielle",
    "#vaitergolpe", "#nãovaitergolpe", "#golpenuncaMais",
    "#grevegeral", "#brasiliademocratica", "#democraciasempre",
    "#sus", "#suséumdireito", "#defendaosus",
    "#educaçãopública", "#educaçãonãoseprivatiza",
    "#foraquiroga", "#foraalckmin", "#psdbnuncaMais",
    "#antifascismo", "#fascismonão", "#resistência",
    "#vidasnegrasimportam", "#blacklivesmatter",
    "#lutafeminista", "#nemumaamenos", "#forabolsonaromisógino",
    "#aquecimentoglobal", "#mudançasclimáticas", "#salveaamazônia",
    "# impeachmentjá", "# impeachmentbolsonaro",
}

PALAVRAS_CHAVE_DIREITA = {
    # Termos econômicos/liberais
    "liberdade", "liberdades", "liberdade econômica", "livre mercado",
    "mercado livre", "capitalismo", "capitalista", "empreendedorismo",
    "empreendedor", "empreendedora", "privatização", "privatizações",
    "desestatização", "desestatizações", "estado mínimo", "governo mínimo",
    "meritocracia", "meritocrático", "meritocrática", "competitividade",
    "competitivo", "competitiva", "produtividade", "eficiência",
    
    # Termos fiscais
    "reforma tributária", "imposto", "impostos", "tributo", "tributos",
    "carga tributária", "menos impostos", "redução de impostos",
    "teto de gastos", "controle de gastos", "equilíbrio fiscal",
    "responsabilidade fiscal", "ajuste fiscal",
    
    # Termos conservadores/valores
    "família", "famílias", "tradicional", "tradicionais", "valores",
    "valores tradicionais", "valores cristãos", "cristão", "cristã",
    "cristãos", "deus", "bíblia", "igreja", "religião", "moral",
    "moralidade", "ética", "bons costumes", "conservador", "conservadora",
    "conservadores", "conservadorismo",
    
    # Segurança/ordem
    "segurança", "segurança pública", "lei", "lei e ordem", "ordem",
    "autoridade", "disciplina", "rigor", "punição", "pena", "penas",
    "armamento", "armas", "direito de defesa", "legítima defesa",
    "combate ao crime", "combate à criminalidade",
    
    # Nacionalismo
    "pátria", "patriota", "patriótico", "patriótica", "nacional",
    "nacionalismo", "soberania", "soberano", "soberana",
    "brasil", "brasileiro", "brasileira", "brasileiros",
    "orgulho nacional", "amor à pátria",
    
    # Críticas ao oponente
    "comunismo", "comunista", "comunistas", "socialismo", "socialista",
    "esquerda", "esquerdista", "esquerdistas", "esquerdopata",
    "globalismo", "globalista", "globalistas", "marxismo", "marxista",
    "cultural", "gramscismo", "ditadura", "ditaduras",
    "populismo", "populista", "populistas", "corrupção", "corrupto",
    "corrupta", "corruptos", "petismo", "petista", "petistas",
    
    # Hashtags DIREITA (peso extra)
    "#bolsonaro", "#bolsonaro2026", "#bolsonaro22", "#bolsonaropresidente",
    "#mito", "#bolsonaromito", "#bolsonaroémito",
    "#brasilacimadetudo", "#deusacimadetudo", "#deusnocentro",
    "#verdadeeleitoral", "#auditoriajá", "#fraudeeleitoral",
    "#intervençãomilitar", "#intervençãojá", "#forçasaramadas",
    "#escolasempartido", "#ideologiadegêneronão",
    "#foralula", "#lulanuncamais", "#ptnuncamais", "#petistaladrão",
    "#canetada", "#canetadobolsonaro",
    ...
    "# impeachmentdolula", "#forapt",
    "#volta mito", "#mitovoltará",
    "# família", "# família tradicional",
}

# PERFIS DE REFERÊNCIA SUPER EXPANDIDOS
PERFIS_REF_ESQUERDA = {
    # Lideranças PT e aliados
    "lulaoficial", "gleisi", "haddad_fernando", "jaqueswagner",
    "ptbrasil", "ptnacional", "RuiFalcaoPt", "ZecaDirceuPT",
    "LindberghFarias", "JeanWyllys", "ErikaHiltonPSOL",
    
    # PSOL e partidos de esquerda
    "GuilhermeBoulos", "psol50", "SampaioMilitante", "MarinaHelenaPSOL",
    "TarcisioMota", "DavidMirandaRJ", "TaliriaPetrone",
    
    # PCdoB e outros
    "RenatoRabelo", "LucianaSantosPCdoB", "ManuelaDavila",
    
    # Governadores e prefeitos
    "FlavioDino", "WellingtonDias", "RafaelFontana",
    "EduardoPaes", "RicardoNunes", "BrunoCovas",
    
    # Movimentos sociais
    "MST_Oficial", "MTST_Oficial", "RedeSustentabilidade",
    "MarinaSilva", "CiroGomes", "andreluis",
    
    # Intelectuais e artistas
    "ConceicaoEvaristo", "SueliCarneiro", "DjamilaRibeiro",
    "ChicoBuare", "CaetanoVeloso", "GilbertoGil",
    
    # Jornalistas/Comunicadores
    "LeonardoSakamoto", "JucaKfouri", "RenataLoPrete",
    "MiriamLeitao", "ReinaldoAzevedoBlog",
}

PERFIS_REF_DIREITA = {
    # Bolsonaro e família
    "jairbolsonaro", "FlavioBolsonaro", "CarlosBolsonaro",
    "EduardoBolsonaro", "MichelBolsonaroRJ",
    
    # Governo Bolsonaro
    "ernestofarau", "SergioMoroOficial", "luizhenriquemandetta",
    "TarcisioGF", "marcos_pereira", "DamaresAlves",
    
    # Parlamentares direita
    "nikolas_ferreira", "CarlaZambelli17", "MajorVitorHugo",
    "ChrisTonietto", "BiaKicis", "CaboDaciolo",
    "FilipeBarros", "Jorge_A_C_Gomes", "Julio_Cesar_Ribeiro",
    
    # Partidos de direita
    "pl_22", "PLnaCamara", "novo", "novo30", "psl_oficial",
    "democratas", "psdb",
    
    # Movimentos de direita
    "MBLivre", "VemPraRua", "EndireitaBrasil", "BrasilParalelo",
    "TerçaLivree", "JovemPanNews",
    
    # Intelectuais e comentaristas
    "olavo_de_carvalho", "Pondé", "LuizPhilippeOrleans",
    "LeandroKarnall", "ArthurDoVal", "NandoMoura",
    "CiroBorges", "RodrigoConstantino",
    
    # Jornalistas/Comunicadores
    "augustusn", "CarlaAraujoBlog", "BernardoKuster",
    "allanjdosantos", "Brasil_247", "Metropoles",
}
...
def limpar_e_tokenizar(texto: str) -> List[str]:
    ...
    texto = re.sub(r"pic\.twitter\.com/\S+", "", texto)  # Remove links de imagem
    
    # Mantém hashtags, menções e palavras com acentos
    texto = re.sub(r"[^\w\s#@áéíóúãõâêîôûàèìòùçÁÉÍÓÚÃÕÂÊÎÔÛÀÈÌÒÙÇ]", " ", texto)
...
def analisar_tokens(tokens: List[str]) -> Tuple[float, float]:
    ...
    for token in tokens:
        ...
        if token.startswith('#'):
            ...
            if token_sem_hash in PALAVRAS_CHAVE_ESQUERDA or token in PALAVRAS_CHAVE_ESQUERDA:
                score_esq += peso
            elif token_sem_hash in PALAVRAS_CHAVE_DIREITA or token in PALAVRAS_CHAVE_DIREITA:
                score_dir += peso
...
# =========================
def coletar_posts_twitter(usuario: str, limite: int, data_corte: datetime) -> List[Dict]:
    ...
    try:
        ...
        for i, tweet in enumerate(scraper.get_items()):
            ...
            post_info = {
                "plataforma": "Twitter",
                "data": tweet.date,
                "conteudo": tweet.rawContent if hasattr(tweet, 'rawContent') else tweet.content,
                "autor_original": usuario,
                "eh_repostagem": tweet.retweetedTweet is not None,
                "autor_repostado": tweet.retweetedTweet.user.username.lower() if tweet.retweetedTweet else None,
                "hashtags": [f"#{tag}" for tag in tweet.hashtags] if tweet.hashtags else [],
                "mencoes": [f"@{mention.username}" for mention in tweet.mentionedUsers] if tweet.mentionedUsers else [],
                "likes": tweet.likeCount if hasattr(tweet, 'likeCount') else 0,
                "reposts": tweet.retweetCount if hasattr(tweet, 'retweetCount') else 0,
            }
        ...
        logger.error(f"Erro ao coletar do Twitter para @{usuario}: {str(e)[:100]}...")
    
    return posts

def coletar_posts_instagram(usuario: str, limite: int, data_corte: datetime) -> List[Dict]:
    ...
    try:
        ...
        for i, post in enumerate(scraper.get_items()):
            ...
            post_info = {
                ...
                "hashtags": re.findall(r"#(\w+)", post.content) if post.content else [],
                "mencoes": re.findall(r"@(\w+)", post.content) if post.content else [],
        ...
        logger.info(f"Coletados {len(posts)} posts do Instagram para @{usuario}")
        
    except Exception as e:
        logger.warning(f"Não foi possível coletar do Instagram para @{usuario}: {str(e)[:100]}...")
...
def analisar_usuario(usuario: str) -> Dict:
    ...
    todos_posts = []
    todos_posts.extend(coletar_posts_twitter(usuario, LIMITE_POSTS_POR_PLATAFORMA, data_corte))
    todos_posts.extend(coletar_posts_instagram(usuario, LIMITE_POSTS_POR_PLATAFORMA, data_corte))
    ...
    for post in todos_posts:
        ...
        dados_detalhados.append({
            ...
            "Data": post["data"].strftime("%Y-%m-%d %H:%M") if isinstance(post["data"], datetime) else post["data"],
    ...
    if total_score == 0:
        resultado = {
            ...
            "plataformas_analisadas": list(set([p["plataforma"] for p in todos_posts]))
        }
    else:
        ...
        if total_score < 5:  # Poucos sinais políticos
            ...
            if pct_esq > pct_dir:
                classificacao = f"Neutro com Inclinação à Esquerda ({pct_esq:.1f}% esq)"
            else:
                classificacao = f"Neutro com Inclinação à Direita ({pct_dir:.1f}% dir)"
            pct_neutro = 100 - pct_esq - pct_dir
        else:
            if pct_esq > pct_dir:
    ...
    if dados_detalhados:
        ...
        nome_arquivo = f"detalhes_{usuario}_{datetime.now().strftime('%Y%m%d_%H%M')}.csv"
        df_detalhes.to_csv(nome_arquivo, index=False, encoding='utf-8-sig', sep=';')
...
if __name__ == "__main__":
    ...
    print(f"{'='*80}")
    print(f"{'USUÁRIO':<25} {'ESQUERDA':<10} {'DIREITA':<10} {'NEUTRO':<10} {'CLASSIFICAÇÃO':<30}")
    print(f"{'-'*80}")
    
    for res in resultados:
        if 'erro' in res:
            print(f"@{res['usuario']:<23} {'N/A':<10} {'N/A':<10} {'N/A':<10} {res['classificacao']}")
        else:
            print(f"@{res['usuario']:<23} {res['esquerda']:<9.1f}% {res['direita']:<9.1f}% {res['neutro']:<9.1f}% {res['classificacao']:<30}")
    
    # Salvar resultados consolidados
    df_resultados = pd.DataFrame(resultados)
    nome_resumo = f"RESUMO_LABORATORIO_{datetime.now().strftime('%Y%m%d_%H%M')}.csv"
    df_resultados.to_csv(nome_resumo, index=False, encoding='utf-8-sig', sep=';')
    ...
    esquerda = [r for r in resultados if 'esquerda' in r and r['esquerda'] > r['direita'] and r['esquerda'] > 50]
    direita = [r for r in resultados if 'direita' in r and r['direita'] > r['esquerda'] and r['direita'] > 50]
    neutros = [r for r in resultados if 'esquerda' in r and max(r['esquerda'], r['direita']) < 60]
    ...
    print(f"Indeterminados (sem dados): {len([r for r in resultados if 'erro' in r])}")
    
    # Salvar estatísticas
    with open(f"estatisticas_{datetime.now().strftime('%Y%m%d')}.txt", "w", encoding="utf-8") as f:
        f.write(f"Laboratório de Análise Política - {datetime.now().strftime('%d/%m/%Y %H:%M')}\n")
    ...
    print(f"\n{'='*80}")
    print("AVISO LEGAL: Esta é uma análise automatizada baseada em conteúdo público.")
    print("Os resultados indicam tendências no conteúdo PUBLICADO/AMPLIFICADO,")
